...
/////////////////
        ...
        for (Pit pit: game.getPlayer1().getHouses()) {
            if (pit instanceof House) {
                sb.append(String.format("|%2d[%2d] ", ((House)pit).getId(), ((House)pit).getSeeds()));
            }
        }
        sb.append("| P1 |");
        io.println(sb.toString());
/////////////////
    ...
    public int printPrompt(Game g) {
        ...
        return io.readInteger("Player "+ g.getTurn().getName() + "'s turn - Specify house number or 'q' to quit: ", 1, Game.HOUSES_PER_PLAYER, -1, "q");
    }
